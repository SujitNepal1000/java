...
public class lab6 {
    public lab6() {
        ...
        panel2.add(addJLabel);
        panel2.add(addTextField);
        JPanel panel3 = new JPanel();
        panel3.add(emailJLabel);
        panel3.add(emailTextField);
        JPanel panel4 = new JPanel();
        panel4.add(countryJLabel);
        panel4.add(countryJComboBox);
        JPanel panel5 = new JPanel();
        panel5.add(maritalStatusJLabel);
        panel5.add(marriedJCheckBox);
        panel5.add(unmarriedJCheckBox);
        panel5.add(singleJCheckBox);
        JPanel panel6 = new JPanel();
        panel6.add(genderJLabel);
        panel6.add(maleButton);
        panel6.add(femaleButton);
        JPanel panel7 = new JPanel();
        panel7.add(TermsJLabel);
        panel7.add(acceptJCheckBox);
